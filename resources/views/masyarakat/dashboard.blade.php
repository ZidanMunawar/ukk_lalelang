                    ...
                    <div class="row justify-content-center gx-4 gy-2">
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="nft-item style-3 light-version">
                                <div class="nft-inner text-center">
                                    <div class="nft-thumb">
                                        <img src="{{ asset('assets-user/images/nft-item/style-3/01.png') }}"
                                            alt="img"style="width: 160px; height: 160px;>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                                        <div class="nft-item style-3 light-version">
                                                                            <div class="nft-inner text-center">
                                                                                <div class="nft-thumb">
                                                                                    <img src="{{ asset('assets-user/images/nft-item/style-3/02.png') }}" alt="img"style="
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="nft-item style-3 light-version">
                                <div class="nft-inner text-center">
                                    <div class="nft-thumb">
                                        <img src="{{ asset('assets-user/images/nft-item/style-3/03.png') }}"
                                            alt="img"style="width: 160px; height: 160px;>
                                                                                </div>
                                                                                <div class="nft-content">
                                                                                    <div class="author-details">
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                                        <div class="nft-item style-3 light-version">
                                                                            <div class="nft-inner text-center">
                                                                                <div class="nft-thumb">
                                                                                    <img src="{{ asset('assets-user/images/nft-item/style-3/04.png') }}" alt="img"style="
                                            width: 160px; height: 160px;>
                                    </div>
                                    <div class="nft-content">
                                        <div class="author-details">
                                ...
                                <div class="nft-inner">
                                    ...
                                    <div class="nft-item-bottom">
                                        <div class="nft-thumb position-relative">
                                            ...
                                            @else
                                                <img src="{{ asset('assets-user/images/nft-item/04.gif') }}" alt="nft-img"
                                                    style="width: 100%; height: 250px; object-fit: cover;">
                                            @endif
                                        ...
                                        <div class="nft-thumb position-relative">
                                            ...
                                            @else
                                                <img src="{{ asset('assets-user/images/nft-item/05.gif') }}"
                                                    alt="nft-img" style="width: 100%; height: 200px; object-fit: cover;">
                                            @endif
            ...
            <div class="section-wrapper">
                <div class="ex-drop-wrapper">
                    <div class="row justify-content-center gx-4 gy-3">
                        @forelse($riwayatUser as $history)
                            @php
                        ...
                        @empty
                            <div class="col-12 text-center py-4">
                                ...
                                <p class="text-muted mt-3">Anda belum mengikuti lelang apapun</p>
                                <a href="{{ route('masyarakat.lelang') }}" class="btn btn-primary">Mulai Lelang</a>
                            </div>
                        @endforelse
                    </div>
                </div>
